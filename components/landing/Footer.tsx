    ...
    <footer className="bg-slate-950 border-t border-slate-800/60 pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-2xl font-bold tracking-tight text-white">VId-z</span>
            </div>
            <p className="text-slate-400 text-sm mb-4">
              The ultimate AI short video generator and multi-platform scheduler. Time-saving technology for serious creators.
            </p>
          </div>
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-slate-500 text-sm">© {new Date().getFullYear()} VId-z Inc. All rights reserved.</p>
